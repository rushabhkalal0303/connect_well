...
class ScalingQuery {
  ...
  ScalingQuery(context) {
    ...
    // print("Short Dimension ${this._shortDimension}");
    // print("Long Dimension ${this._longDimension}");
  }
  ...
  double verticalScale(double size) {
    //print("longDimension--" + this._longDimension.toString());
    //print("guidelineBaseHeight--" + this._guidelineBaseHeight.toString());
    //print("guidelineBaseHeight * size--" +
    //    (this._guidelineBaseHeight * size).toString());
    //print("verticalScale--" +
    //    (this._longDimension / this._guidelineBaseHeight * size).toString());
